(function() {
  ...
  function zfActionSheet(foundationApi) {
    var directive = {
      ...
      transclude: true,
      replace: true,
      templateUrl: 'assets/actionsheet/actionsheet.html',
  ...
  function zfAsContent(foundationApi) {
    var directive = {
      ...
      transclude: true,
      replace: true,
      templateUrl: 'assets/actionsheet/actionsheet-content.html',
  ...
  function zfAsButton(foundationApi) {
    var directive = {
      ...
      transclude: true,
      replace: true,
      templateUrl: 'assets/actionsheet/actionsheet-button.html',
      require: '^zfActionSheet',
      scope: {
        title: '@?'
      },
